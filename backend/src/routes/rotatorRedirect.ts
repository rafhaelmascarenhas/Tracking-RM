...
p{font-size:.95rem;color:#6b7280;margin-bottom:2rem;line-height:1.6}
a{display:inline-flex;align-items:center;gap:.6rem;background:#25D366;color:#fff;text-decoration:none;font-weight:600;font-size:1.05rem;padding:1rem 2.5rem;border-radius:100px;box-shadow:0 4px 20px rgba(37,211,102,.4);transition:transform .1s,box-shadow .1s}
a:hover{box-shadow:0 6px 24px rgba(37,211,102,.5)}
